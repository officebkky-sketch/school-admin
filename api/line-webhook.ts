...
async function handleFullAIQuery(replyToken: string, message: string, profile: any) {
  try {
    ...
    1. ห้ามเกริ่นนำเด็ดขาด เช่น "ในฐานะ AI..." หรือ "ยินดีให้บริการ..." ให้ตอบเข้าประเด็นทันที
    2. ห้ามใช้สัญลักษณ์ดอกจัน (**) เพื่อทำตัวหนาเด็ดขาด เพราะทำให้อ่านยากบน LINE
    3. จัดรูปแบบให้สะอาดตา:
       - ใช้ Emoji นำหน้าหัวข้อสำคัญเท่านั้น (📝, 📊, 📋, 💡, ✅)
       - ใช้การเว้นบรรทัด (New Line) เพื่อแยกส่วนข้อมูลแทนการใช้ตัวหนา
       - ใช้รายการสัญลักษณ์ (Bullet points) เช่น - หรือ 🔹 เพื่อสรุปรายชื่อ
    ...
    📋 รายชื่อนักเรียน:
    1. 3870 เด็กชายอัชรอฟ น่วมหมุน
    2. 3871 เด็กหญิงอริสา ทิพย์จำนงค์
    
    💡 หากต้องการข้อมูลอื่น แจ้งได้เลยครับ

    ตอบอย่างมืออาชีพ สุภาพ มีหางเสียง (ครับ/ค่ะ) และเข้าเรื่องทันที`;
